...
@Transactional
public class ApiMobilePlansServiceImpl implements ApiMobilePlansService {

	private static final Logger LOGGER = LoggerFactory.getLogger(ApiMobilePlansServiceImpl.class);
	...
	public ResponseEntity<String> getMobilePlans(ApiMobilePlanRequest mplanRequest) throws JsonProcessingException {
		...
		// CommonServiceUtil.matchAmountInPlans(result, 11);
		return new ResponseEntity<String>(result, HttpStatus.OK);
	}
	...
	@Override
	public ResponseEntity<String> getMobilePlansquery(String operator, String circle) throws JsonProcessingException {
		LOGGER.info("Entered getMobilePlansquery() -> Start");
		//ObjectMapper objMapper = new ObjectMapper();
		LOGGER.info("Parameter operator -> " + operator);
		LOGGER.info("Parameter circle -> " + circle);
