...
@NoArgsConstructor
@Entity
public class OpPrepaidMobile implements Serializable {
	...
	public String getCodePlanInfo() {
		return codePlanInfo;
	}

	public void setCodePlanInfo(String codePlanInfo) {
		this.codePlanInfo = codePlanInfo;
	}
